document.write('<nav class="navbar-default navbar-static-side" role="navigation">' +
    ' <div class="sidebar-collapse"> ' +
    '<ul class="nav metismenu" id="side-menu">' +
    ' <li class="nav-header"> <div class="dropdown profile-element">' +
    ' <span> <img alt="image" class="img-circle" src="../img/profile_small.jpg" /></span> ' +
    '<span class="clear"> ' +
    '<span class="block m-t-xs"><strong class="font-bold"><a href="profile.html">Username</a></strong></span> ' +
    '</span> </span> </div> </li> ' +
    '<li class="active"> <a href="grid_options.html"><i class="fa fa-slideshare"></i>' +
    ' <span class="nav-label">Create help request</span></a> </li> ' +
    '<li> <a href="grid_options.html"><i class="fa fa-handshake-o"></i> <span class="nav-label">Create Offer</span></a> </li>' +
    ' <li> <a href="grid_options.html"><i class="fa fa-plus-square"></i> <span class="nav-label">See Offers</span></a> </li> <li>' +
    ' <a href="grid_options.html"><i class="fa fa-plus-square-o"></i>' +
