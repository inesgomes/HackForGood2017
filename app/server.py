...
class WebApp(object):
    ...
    @cherrypy.expose
    def listall(self):
        return open("app/listall.html")

    @cherrypy.expose
    def login(self):
        return open("app/login.html")

    @cherrypy.expose
    def main(self):
        return open("app/main.html")

    @cherrypy.expose
    def profile(self):
        return open("app/profile.html")

    @cherrypy.expose
    def sendMessage(self):
        return open("app/sendMessage.html")

    @cherrypy.expose
    def signup(self):
        return open("app/signup.html")

    @cherrypy.expose
    def ticket(self):
        return open("app/ticket.html")

    @cherrypy.expose
    def ticketView(self):
        return open("app/ticketView.html")
